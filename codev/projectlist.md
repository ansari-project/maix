...
- `devops`, `tooling` - Development workflow and tools
...
projects:
  - id: "0001"
    ...
    files:
      ...
      plan: codev/plans/0001-codev-adoption.md
      review: null
    dependencies: []
    tags: [devops, tooling, infrastructure]
    notes: "First codev project for Maix. Foundational work to enable all future development."
```
